  ...
  return (
    <div className={`contact-page ${isDark ? 'contact-dark' : 'contact-light'}`}>
      <div className="contact-container">
          ...
          <div>
            ...
            <div className="contact-panel">
              ...
              <div className="quick-actions">
                <Button variant="outline" className="contact-action-button">
                  <svg fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        {/* FAQ Section */}
        <div className="contact-panel faq-panel">
          <h2 className="contact-title" style={{ textAlign: 'center', fontSize: '28px', marginBottom: '24px' }}>
